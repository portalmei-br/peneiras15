// Dados simulados de peneiras de futebol - VERSÃO MODIFICADA SEM PRAZO DE INSCRIÇÃO
const peneirasData = [
    {
        id: 1,
        ...
        endereco: "Vila Belmiro, Santos, SP", // Será substituído pela busca do CEP
        data: "2024-08-15",
        horario: "14:00",
    ...
    },
    {
        ...
        cep: "12916-440", // CEP de Bragança Paulista
...
function initializeApp() {
    ...
    // Buscar endereços por CEP para todas as peneiras
    updatePeneirasAddresses();
}

// NOVA FUNÇÃO: Atualizar endereços das peneiras com base no CEP
async function updatePeneirasAddresses() {
    for (let peneira of peneirasData) {
        try {
            ...
            console.log(`Erro ao buscar endereço para CEP ${peneira.cep}:`, error);
            // Manter endereço original em caso de erro
        }
    }
}

// NOVA FUNÇÃO: Buscar endereço por CEP usando ViaCEP
...
// FUNÇÃO MODIFICADA PARA CRIAR CARD DE RESULTADO - SEM BLOCO DE PRAZO DE INSCRIÇÃO
